                  ...
                  <table class="table" id="detail_cart">
                    <tbody>
                        ...
                        <td class="text-left hide-text-option-cart">
                                                    <a
                            href="https://divineshop.vn/index.php?route=product/product&product_id=">Left 4 Dead 2</a>
                          
                                                                            </td>
                        <td class="text-right"><i style="color: black">Số lượng: 1</i></td>
                        <td class="text-right">119,000 VNĐ</td>
                        <td class="text-center"><button type="button"
                            onclick="cart.remove('3099992');" title="Loại bỏ"
                    ...
                    <table class="table table-bordered">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-right">
                            119,000                            <i class="icon-coin-dollar" style="color: black"></i></td>
                        </tr>
                                              </tbody>
                    </table>
                    <p class="checkout">
