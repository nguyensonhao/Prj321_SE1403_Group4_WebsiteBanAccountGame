<%-- 
    Document   : accountLienQuan
    Created on : Jul 15, 2020, 5:37:09 PM
    Author     : Hao Nguyen 
--%>
        ...
        <body>
            ...
            <div class="container">
                <div style="text-align:center;margin-bottom:22px;">
                    <strong><h1>Account Liên Quân Mobile</h1></strong>
                </div>
                ...
                <div class="row" style="margin-top:25px;margin-bottom:50px;">
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <strong><h4>Liên Quân Mobile</h4></strong>
                    </div>
                </div>
                                ...
                                <div class="item-game-wrapper">
                                    ...
                                    <div class="item-info">
                                        <div class="item-title">
                                            <a href="link thanh toan"><font style="font-family:Bookman ; font-size:14pt">${row.pName }</a>
