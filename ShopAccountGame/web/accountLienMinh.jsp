<%-- 
    Document   : accountLienMinh
    Created on : Jul 15, 2020, 5:27:23 PM
    Author     : Hao Nguyen 
--%>
                            ...
                            <div class="header-menu dropdown" id="category-product">
                                ...
                                <div class="dropdown-menu drop-category nav-menu" aria-labelledby="dropdownMenuLink">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="accountLienMinh"><i class="fas fa-trophy"></i>
...
<!--*************-->
            ...
            <div class="container">
                <div style="text-align:center;margin-bottom:22px;">
                    <strong><h1>Account Liên Minh Huyền Thoại</h1></strong>
                </div>
                ...
                <div class="row" style="margin-top:25px;margin-bottom:50px;">
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <strong><h4>Liên minh huyền thoại</h4></strong>
                    </div>
                </div>
            ...
            <div class="list-sp">
                ...
                <div class="list-container">
                                ...
                                <div class="item-game-wrapper">
                                    ...
                                    <div class="item-info">
                                        <div class="item-title">
                                            <a href="ProductDetail?id=${row.pId}"><font style="font-family:Bookman ; font-size:14pt">${row.pName }</font></a>
                 ...
                 <div class="view-more btn-aqua" id="" onclick="">Tải thêm sản phẩm</div>
            </div>
        </div>
